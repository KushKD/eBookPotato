...
public class Physiologicalstorage extends AppCompatActivity implements TextLinkClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_physiologicalstorage);
        ...
        back_Bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Physiologicalstorage.this.finish();
            }
        });
    }
